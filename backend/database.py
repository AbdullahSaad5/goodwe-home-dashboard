...
class DashboardDatabase:
    ...
    def _initialize(self) -> None:
        statements = [
            ...
            "CREATE INDEX IF NOT EXISTS idx_aggregates_resolution_ts ON aggregates(resolution, bucket_ts)",
    ...
    def _period_bounds(self, period: str, anchor: date | None = None) -> tuple[datetime, datetime, str]:
        durations = {
        ...
        start = datetime.combine(start_date, datetime_time.min, tzinfo=self.timezone).astimezone(UTC)
