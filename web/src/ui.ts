  ...
  return [
    {
      ...
      value: formatPower(snapshot.power.pv_w),
      detail: `Today ${formatNumber(snapshot.today.solar_kwh)} kWh`,
      tone: 'solar',
    },
    {
      id: 'home',
      label: 'Home consumption',
      value: formatPower(snapshot.power.home_w),
      detail: `Today ${formatNumber(snapshot.today.load_kwh)} kWh`,
      tone: 'home',
    },
    {
      id: 'battery',
      label: `Battery ${formatNumber(snapshot.power.battery_soc_pct, 0)}%`,
      value: formatPower(snapshot.power.battery_w),
      detail: snapshot.power.battery_direction,
      tone: 'battery',
    },
    {
      id: 'grid',
      label: gridLabel,
      value: formatPower(snapshot.power.grid_w),
      detail: `Today ${formatNumber(gridCounter)} kWh`,
      tone: 'grid',
    },
  ];
}
